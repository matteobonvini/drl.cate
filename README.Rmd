...
> _Note_: This README is generated from **`README.Rmd`**. Don’t edit `README.md` directly.
...
- Function reference: `?drl_cate`, `?predict.drl_cate`, `?summary.drl_cate`  
- Vignettes (coming soon) will demonstrate end-to-end workflows.

## Contributing

Contributions are welcome! Please open an issue or submit a pull request.  
Before submitting, run `devtools::check()` and the test suite via `devtools::test()`.
